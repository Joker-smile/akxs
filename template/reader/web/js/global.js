    ...
    var Book = {
        ...
        navCata: function (e) {
            ...
            if ($('.catalog-list-wrap').length == 0) {
            	 $.ajax({
                    type: 'GET',
                    url: '/index.php?s=/home/chapter/lists',
                    data: {
                        id: book.Info.Id
                    },
        ...
        phoneRead: function(e){
            ...
            $('#code').qrcode({ 
                ...
                width: 120, //宽度 
                height:120, //高度 
                text: window.location.protocol+"//"+document.domain+book.chapterUrl.replace("chapterId", book.chapter.id)
            });
        },
         /**
         * 返回页面顶部
        ...
        getChapterInfo: function (chapterId, isRepeat, advanceBool, successCallback, failCallBack) {
            ...
            $.ajax({
                type: 'GET',
                url: '/index.php?s=/home/chapter/info',
                dataType: 'json',
                data: {id: book.Info.Id, key: chapterId},
                success: function (response) {
                    if (response.code == 1) {
        ...
        chapterContent: function(data){
            ...
            chapter_box_jq.find('.read-content j_readContent').html(data.chapter.content);
